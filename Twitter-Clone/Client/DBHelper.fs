...
let insertLog (logDTO: LogDTO) = 
    ...
    let command = createSQLiteCommand query (dict [ ("@id", logDTO.ID :> Object); ("@logTime", logDTO.logTime :> Object); ("@level", logDTO.logLevel :> Object); ("@type", logDTO.logType :> Object); ("@username", logDTO.username :> Object); ("@log", logDTO.log :> Object); ])
